...
class DismissibleTest extends BaseTestCase
{
    ...
    #[Test]
    public function with_scope_active_it_does_not_return_the_dismissible_when_now_is_before_active_from()
    {
    ...
    #[Test]
    public function without_scope_active_it_does_return_the_dismissible_when_now_is_before_active_from()
    {
        Dismissible::factory()->create([
            'active_from' => Carbon::createFromFormat('d-m-Y H:i:s', '01-01-2023 01:00:00'),
        ]);
    ...
    #[Test]
    public function with_scope_active_it_returns_the_dismissible_when_now_is_in_active_period()
    {
        Dismissible::factory()->create([
    ...
    #[Test]
    public function without_scope_active_it_returns_the_dismissible_when_now_is_before_active_from()
    {
        Dismissible::factory()->create([
            'active_from'  => Carbon::createFromFormat('d-m-Y H:i:s', '01-01-2023 14:00:00'),
            'active_until' => Carbon::createFromFormat('d-m-Y H:i:s', '31-01-2023 23:59:59'),
    ...
    #[Test]
    public function with_scope_active_it_does_not_return_the_dismissible_when_now_is_after_active_period()
    {
        Dismissible::factory()->create([
            'active_from'  => Carbon::createFromFormat('d-m-Y H:i:s', '01-01-2023 14:00:00'),
            'active_until' => Carbon::createFromFormat('d-m-Y H:i:s', '31-01-2023 23:59:59'),
    ...
    #[Test]
    public function with_scope_active_it_does_returns_the_dismissible_when_now_is_after_active_from_and_active_until_is_null()
    {
        Dismissible::factory()->create([
            'active_from'  => Carbon::createFromFormat('d-m-Y H:i:s', '01-01-2023 14:00:00'),
            'active_until' => null,
    ...
    #[Test]
    public function without_scope_active_it_returns_the_dismissible_when_now_is_after_active_period()
    {
        Dismissible::factory()->create([
            'active_from'  => Carbon::createFromFormat('d-m-Y H:i:s', '01-01-2023 14:00:00'),
            'active_until' => Carbon::createFromFormat('d-m-Y H:i:s', '31-01-2023 23:59:59'),
